	...
	return (
		<Grid className={classes.root} item container justify="space-between" alignItems="center">
			...
			<div className={classes.quantity}>
				<IconButton aria-label="" onClick={() => updateCart(product_id_id, 'add', 1)}>
					<AddIcon />
				</IconButton>
				...
				<IconButton aria-label="" onClick={() => updateCart(product_id_id, 'subtract', 1)}>
					<RemoveIcon />
				</IconButton>
			</div>

			<div>
				<IconButton aria-label="" onClick={() => updateCart(product_id_id, 'delete', 1)}>

                    ...
                    (
                        categories.map(item => (
                            (item.category === tabCategory) ?
                                <div key={item.id} className={classes.tabItemActive} onClick={() => tabCategoryHandler(item.category)}>{item.category}</div> 
                                    :
                                <div key={item.id} className={classes.tabItem} onClick={() => tabCategoryHandler(item.category)}>{item.category}</div> 
                        ))
                    ) : null
               }
